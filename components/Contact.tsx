   ...
   return (
      <div className="max-w-4xl mx-auto px-6 md:px-0">
         <div className="text-center mb-20 relative">
            ...
            <p className="mb-8" style={{ color: colors.textPrimary }}>I'm always curious to learn about new challenges.</p>
         ...
         <div className="max-w-xl mx-auto">
            ...
            <form ref={form} onSubmit={handleSubmit} className="relative space-y-8">
               ...
               <div className="relative group">
                  <label className="absolute -top-3 left-4 bg-blueprint-bg px-2 text-sm font-mono text-white z-10">Name</label>
                  <input
                     type="text"
                     name="name"
                     required
                     className="w-full bg-transparent border-2 border-white/40 rounded-lg p-4 outline-none focus:border-blueprint-grid transition-colors font-hand text-xl text-white placeholder-white/20"
                     style={{
               ...
               <div className="relative group">
                  <label className="absolute -top-3 left-4 bg-blueprint-bg px-2 text-sm font-mono text-white z-10">Email</label>
                  <input
                     type="email"
                     name="email"
                     required
               ...
               <div className="relative group">
                  <label className="absolute -top-3 left-4 bg-blueprint-bg px-2 text-sm font-mono text-white z-10">Message</label>
                  <textarea
                     rows={5}
                     name="message"
                     required
            ...
            {sent && (
               <div className="fixed inset-0 flex items-center justify-center pointer-events-none z-50">
                  <div className="bg-blueprint-bg border-4 border-double border-white p-8 -rotate-6 shadow-2xl animate-[bounce_0.5s_ease-out]">
                     ...
                     <p className="font-mono text-sm" style={{ color: colors.textSecondary }}>I'm probably excited already.</p>
                  </div>
               </div>
            )}
